...
export const metadata = {
  title: "Add nationality | Admin",
};

type TView = { kind: "forbidden" } | { kind: "ok"; canWrite: boolean };

export default async function AdminCatalogNationalityNewPage() {
  ...
  return (
    <AdminShell
      title="Add nationality"
      active="catalog"
      subtitle="Create a nationality with an ISO alpha-2 code."
    >
      <CatalogNationalityForm mode="create" canWrite={view.canWrite} />
    </AdminShell>
  );
}
